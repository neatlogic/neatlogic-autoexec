 ...
 **/
@Service
public class AutoexecJobConsoleLogTailNewHandler extends AutoexecJobActionHandlerBase {
    private final static Logger logger = LoggerFactory.getLogger(AutoexecJobConsoleLogTailNewHandler.class);
    @Resource
    RunnerMapper runnerMapper;

    @Override
    public String getName() {
        return JobAction.CONSOLE_LOG_TAIL_NEW.getValue();
    }
    ...
    public JSONObject doMyService(AutoexecJobVo jobVo) {
        ...
        String url = paramObj.getString("runnerUrl") + "/api/rest/job/console/log/tail/new";
