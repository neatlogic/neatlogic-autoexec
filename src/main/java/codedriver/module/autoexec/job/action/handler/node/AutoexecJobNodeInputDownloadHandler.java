 ...
 **/
@Service
public class AutoexecJobNodeInputDownloadHandler extends AutoexecJobActionHandlerBase {
    private final static Logger logger = LoggerFactory.getLogger(AutoexecJobNodeInputDownloadHandler.class);

    @Override
    public String getName() {
        return JobAction.DOWNLOAD_NODE_IN_PUT.getValue();
    }
    ...
    public JSONObject doMyService(AutoexecJobVo jobVo) throws Exception {
        ...
        String url = String.format("%s/api/binary/job/phase/node/input/download", nodeVo.getRunnerUrl());
