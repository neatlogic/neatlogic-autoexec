...
public class DeleteAutoexecJobApi extends PrivateApiComponentBase {
    ...
    public String getName() {
        return "nmaa.deleteautoexecjobapi.getname";
    }
    ...
    @Description(desc = "nmaa.deleteautoexecjobapi.getname")
    @Override
